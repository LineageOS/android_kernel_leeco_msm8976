...
/*Begin added by yangyongfeng to add check pin value of camera id  (ql1530) 20151221 */
...
/*End added by yangyongfeng to add check pin value of camera id  (ql1530) 20151221 */
	return rc;
